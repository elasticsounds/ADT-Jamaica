function playaudio(myid1,myid2,color1,color2)
{
	...
	document.getElementById('a18a').style.color="black";
	document.getElementById('a19').style.color="black";
	document.getElementById('a19a').style.color="black";
	document.getElementById('a20').style.color="black";
	document.getElementById('a20a').style.color="black";
	document.getElementById('a21').style.color="black";
	document.getElementById('a21a').style.color="black";
	document.getElementById('a22').style.color="black";
	document.getElementById('a22a').style.color="black";
	document.getElementById('a23').style.color="black";
	document.getElementById('a23a').style.color="black";
