...
currentStep = 0;
    ...
    $('.exit').bind('click', function (e) {
        ...
        $('.b_text_w').html('<span>Choose the word on the right of the screen that goes best with the word on the left. <br/><br/>I will do the first one for you. </span>');
		}
	...
	$('.done').bind('click', function (e) {
		...
		document.getElementById('img5').style.display="none";
		document.getElementById('img6').style.display="none";
		document.getElementById('pg29a').click();
		//console.log("exit");
		/*e.preventDefault();
        var myid=this.id;
		console.log(myid);
    ...
    $('#cont2').bind('touchstart click', function (e) {
        ...
        $('.b_text_w').html('<span>Choose the word on the right of the screen that goes best with the word on the left.<br/></span>');
        pause_all();
