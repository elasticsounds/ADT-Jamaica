...
currentStep = 0;
    ...
    $('.exit').bind('click', function (e) {
        ...
        $('.b_text_w').html('<span>Read the statement carefully. Click, tap or touch the correct name to say Who I Am. <br/><br/>I will do the first one for you. </span>');
		}
	...
	$('.done').bind('click', function (e) {
		console.log("done");
		document.getElementById('pg28a').click();
		//console.log("exit");
		/*e.preventDefault();
        var myid=this.id;
		console.log(myid);
    ...
    $('#cont2').bind('touchstart click', function (e) {
        ...
        $('.b_text_w').html('<span>Read the statement carefully. Click, tap or touch the correct name to say Who I Am. <br/></span>');
        pause_all();
